      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="bg-white rounded-2xl shadow-xl p-8">
          ...
          <div className="prose prose-lg max-w-none">
            ...
            <h2 className="text-2xl font-bold text-gray-900 mt-8 mb-4">3. Elegibilidade</h2>
            <p className="text-gray-600 mb-4">
            ...
            <h2 className="text-2xl font-bold text-gray-900 mt-8 mb-4">4. Pagamentos e Preços</h2>
            ...
            <h2 className="text-2xl font-bold text-gray-900 mt-8 mb-4">5. Direitos de Propriedade Intelectual</h2>
            <p className="text-gray-600 mb-4">
            ...
            <div className="mt-12 p-6 bg-blue-50 rounded-lg">
              <h3 className="text-xl font-bold text-gray-900 mb-3">Aceitação dos Termos</h3>
              <p className="text-gray-600 mb-4">
