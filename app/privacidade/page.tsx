      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="bg-white rounded-2xl shadow-xl p-8">
          ...
          <div className="prose prose-lg max-w-none">
            ...
            <h2 className="text-2xl font-bold text-black mt-8 mb-4">1. Informações que Coletamos</h2>
            <h3 className="text-xl font-bold text-black mt-4 mb-2">Informações fornecidas por você:</h3>
            ...
            <h3 className="text-xl font-bold text-black mt-4 mb-2">Informações coletadas automaticamente:</h3>
            <ul className="list-disc list-inside text-black mb-4 space-y-2">
              <li>Endereço IP</li>
            ...
            <h2 className="text-2xl font-bold text-black mt-8 mb-4">2. Como Usamos suas Informações</h2>
            <ul className="list-disc list-inside text-black mb-4 space-y-2">
            ...
            <h2 className="text-2xl font-bold text-black mt-8 mb-4">3. Compartilhamento de Informações</h2>
            ...
            <h2 className="text-2xl font-bold text-black mt-8 mb-4">4. Segurança das Informações</h2>
            <p className="text-black mb-4">
              Implementamos medidas de segurança técnicas e organizacionais para proteger suas 
              informações pessoais contra acesso não autorizado, alteração, divulgação ou destruição.
            </p>
            
            <h2 className="text-2xl font-bold text-black mt-8 mb-4">5. Seus Direitos</h2>
            <p className="text-black mb-4">
            ...
            <h2 className="text-2xl font-bold text-black mt-8 mb-4">6. Cookies e Tecnologias Semelhantes</h2>
            <p className="text-black mb-4">
            ...
            <h2 className="text-2xl font-bold text-black mt-8 mb-4">7. Alterações nesta Política</h2>
            <p className="text-black mb-4">
            ...
            <div className="mt-12 p-6 bg-blue-50 rounded-lg">
              <h3 className="text-xl font-bold text-black mb-3">Proteção de Dados</h3>
              <p className="text-black mb-4">
