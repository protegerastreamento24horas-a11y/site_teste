        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <h3 className="text-xl font-bold mb-4">
              <span className="text-blue-600">Rifa</span>
              <span className="text-yellow-500">Fácil</span>
            </h3>
            <p className="text-black">
              A maneira mais fácil e segura de participar de rifas online com pagamento via PIX.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link href="/termos" className="text-black hover:text-blue-600 transition">Termos de Uso</Link></li>
              <li><Link href="/privacidade" className="text-black hover:text-blue-600 transition">Política de Privacidade</Link></li>
              <li><Link href="/faq" className="text-black hover:text-blue-600 transition">FAQ</Link></li>
              <li><Link href="/contato" className="text-black hover:text-blue-600 transition">Contato</Link></li>
            </ul>
          </div>
