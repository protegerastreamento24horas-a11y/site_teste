        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <h3 className="text-xl font-bold mb-4">
              <span className="text-blue-400">Rifa</span>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link href="/" className="text-gray-300 hover:text-white transition">Início</Link></li>
              <li><Link href="/rifas" className="text-gray-300 hover:text-white transition">Rifas</Link></li>
              <li><Link href="/minhas-rifas" className="text-gray-300 hover:text-white transition">Minhas Rifas</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link href="/privacidade" className="text-gray-300 hover:text-white transition">Política de Privacidade</Link></li>
