      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8 mb-16">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-3xl font-bold text-black mb-6">Processo Completo</h2>
              <div className="space-y-6">
                <div className="flex">
                  ...
                  <div className="ml-4">
                    <h3 className="text-lg font-medium text-black">Escolha uma Rifa</h3>
                ...
                <div className="flex">
                  ...
                  <div className="ml-4">
                    <h3 className="text-lg font-medium text-black">Compre suas Rifas</h3>
                    <p className="mt-2 text-black">
                ...
                <div className="flex">
                  ...
                  <div className="ml-4">
                    <h3 className="text-lg font-medium text-black">Aguarde o Sorteio</h3>
                    <p className="mt-2 text-black">
                ...
                <div className="flex">
                  ...
                  <div className="ml-4">
                    <h3 className="text-lg font-medium text-black">Receba seu Prêmio</h3>
                    <p className="mt-2 text-black">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
          <div className="bg-white rounded-2xl shadow-lg p-6">
            ...
            <h3 className="text-xl font-bold text-black mb-3">Segurança</h3>
          ...
          <div className="bg-white rounded-2xl shadow-lg p-6">
            <div className="text-4xl mb-4">🔄</div>
            <h3 className="text-xl font-bold text-black mb-3">Transparência</h3>
            <p className="text-black">
          ...
          <div className="bg-white rounded-2xl shadow-lg p-6">
            <div className="text-4xl mb-4">🏆</div>
            <h3 className="text-xl font-bold text-black mb-3">Prêmios Reais</h3>
            <p className="text-black">
        ...
        <div className="bg-gradient-to-r from-blue-600 to-indigo-700 rounded-2xl shadow-xl p-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            ...
            <Link 
              href="/minhas-rifas" 
              className="px-8 py-4 bg-white hover:bg-gray-100 text-black font-bold rounded-full transition duration-300"
            >
              Ver Minhas Rifas
            </Link>
          </div>
